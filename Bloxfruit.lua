...
local Fz = {
		...
		["Logo Image"] = "rbxassetid://11176073582",
...
gz.Image = "rbxassetid://11176073582";
...
local Uz = function(Y)
		...
		local g = D .. ("," .. (A .. ("," .. u)));
		K.Text = "<font color=\"rgb(" .. (g .. (")\">ThZ Hub</font> " .. dz.TitleNameNoti));
...
function Kz.CreateMain(Y)
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">ThZ Hub</font> : Blox Fruits");
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">ThZ Hub </font> : Blox Fruits");
	K.Name = "Background1";
	K.Parent = g;
